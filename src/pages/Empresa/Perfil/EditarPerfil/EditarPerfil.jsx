...
export function EditarPerfil(){
  ...
  async function UpdatePerfil(){
    await firebase.firestore().collection('userEmp').doc(user?.uid)
    .update({
        nome: nome,
        urlPhoto: urlPhoto,
        cnpj:cnpj,
  ...
  return(
    <div className="EditPerfilbody">
      ...
      <Link to="/perfilEmp" ><CaretLeft className="carretPer" size={28} color='#000' /></Link>
      ...
      <div className="formPerfil">
          ...
          <label >CNPJ:</label>
          <MaskInput  type="number"  name= "cnpj"
              mask= "99.999.999/9999-99"  onChange={(e) => setCnpj(e.target.value)} value={cnpj} />
